...
`80_manual.json` 은 1,440개 주문 로드오더의 스캔(2026-09-21)을 보고 만든 20개다:

- 혈: AncientBlood 의 흡혈의 오로라, 피의 불꽃 소용돌이, 박쥐의 연회, Occult Cradle 의 내면의 힘,
  Mysticism 의 피의 창과 흡혈(Vampiric, 한국어로 엔트로피) 다섯 개
...
에 두면 된다. 남은 판단거리: Natura 의 바위 주문들은 "출혈 피해"를 주지만 흙 마법이라 혈을 붙이지
않았다.
